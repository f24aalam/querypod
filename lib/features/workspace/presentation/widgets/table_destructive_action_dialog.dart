  ...
  static void show(
    ...
    showFDialog(
      ...
      builder: (dialogContext, style, animation) => MultiBlocProvider(
        providers: [
          BlocProvider.value(value: context.read<WorkspaceMetadataCubit>()),
  ...
  Future<void> _submit() async {
    ...
    try {
      if (widget.actionType == DestructiveActionType.drop) {
        await context.read<WorkspaceMetadataCubit>().dropTable(
              widget.connection,
              widget.database,
              widget.tableName,
              cascade: _force,
        ...
        await context.read<WorkspaceMetadataCubit>().truncateTable(
              widget.connection,
              widget.database,
              widget.tableName,
              cascade: _force,
