...
class $$AppSettingsTableFilterComposer
    extends Composer<_$QueryPodDatabase, $AppSettingsTable> {
...
class $$AppSettingsTableTableManager
    extends
        RootTableManager<
          ...
          PrefetchHooks Function()
        > {
  $$AppSettingsTableTableManager(_$QueryPodDatabase db, $AppSettingsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$AppSettingsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        AppSettingRow,
        BaseReferences<_$QueryPodDatabase, $AppSettingsTable, AppSettingRow>,
      ),
      AppSettingRow,
      PrefetchHooks Function()
    >;
